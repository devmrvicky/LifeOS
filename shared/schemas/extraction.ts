...
// ---------------------------------------------------------------------------
// The single source of truth for the extraction schema. Both frontend
// (frontend/src/lib/validation.ts) and server (server/src/validators/) import
// this directly rather than each keeping their own copy — Phase 1.1 shipped
// with two hand-duplicated schemas that had to be kept in sync by hand, and
// that's exactly the kind of drift this shared/ folder exists to prevent.
// ---------------------------------------------------------------------------
